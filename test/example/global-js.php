		...
		getScript('assets/js/bootstrap.min.js',function(){
			...
			<?php if (pathinfo(basename($_SERVER['REQUEST_URI']), PATHINFO_FILENAME) == "modul-page-write"){
				echo '/* include summernote css/js */
					getScript("https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.9/summernote.js",function(){
						$("head").append(\'<link href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.9/summernote.css" rel="stylesheet">\');
